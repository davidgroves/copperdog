...
BLOG_AUTHOR = "David Groves"  # (translatable)
BLOG_TITLE = "Copperdog"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://copperdog.org/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://copperdog.org/"
BLOG_EMAIL = "blog@fibrecat.org"
BLOG_DESCRIPTION = "Copperdog Blog + Stuff"  # (translatable)
...
# is in the manual.
COMMENT_SYSTEM_ID = "1521405454851251"
